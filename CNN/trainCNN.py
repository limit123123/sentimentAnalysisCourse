...
def train(config,model,train_iter,dev_iter):
        ...
        for i,(trains,labels) in enumerate(train_iter):
            ...
            if total_batch % 100 == 0:
                ...
                if dev_loss < dev_best_loss:
                    ...
                    improve = ''
                print("Iter:{} TrainLoss:{} TrainAcc:{} DevLoss:{} DevAcc:{} Improve:{}".format(total_batch,loss.item(),train_acc,dev_loss,dev_acc,improve))
    ...
    writer.close()
    end_time = time.time()
    print("Train Time : {}min".format((float)((end_time-start_time))/60))
